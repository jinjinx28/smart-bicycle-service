  ...
  return (
    <div className="min-h-screen bg-bg text-white">
      <div className="relative h-[420px] w-full overflow-hidden">
        <img 
          src={route.image || route.thumbnail || route.img || "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?auto=format&fit=crop&w=1200&q=80"} 
          alt={route.name} 
            ...
            <div className="space-y-3">
              {otherRoutes.map((r) => (
                <Link key={r.id} to={ROUTES.routeDetail(r.id)} className="flex items-center gap-3 hover:opacity-80">
                  <img 
                    src={r.image || r.thumbnail || r.img || "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?auto=format&fit=crop&w=300&q=80"} 
                    alt={r.name} 
